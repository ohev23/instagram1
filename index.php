				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<form method="GET" action="delete.php">
	 					...
	 					<button class="btn btn-success btn1 mt-1">редактировать</button>
	 					<form method="GET" action="update.php" class="mt-3 form1" style="display:none;">
	 						<input placeholder="id" value="<?php echo $stroka["id"];?>" type="" name="id" class="form-control mt-1">
							<input placeholder="text" value="<?php echo $stroka["text"];?>" type="" name="text" class="form-control mt-1">
